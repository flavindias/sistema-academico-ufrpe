...
[wxID_FRAMEADDPROFESSOR, wxID_FRAMEADDPROFESSORBOTAOBUSCAR, 
 wxID_FRAMEADDPROFESSORBOTAOCADASTRAR, wxID_FRAMEADDPROFESSORBOTAOFEMININO, 
 wxID_FRAMEADDPROFESSORBOTAOMASC, wxID_FRAMEADDPROFESSORCAMPOBAIRRO, 
 ...
 wxID_FRAMEADDPROFESSORCAMPOCPF, wxID_FRAMEADDPROFESSORCAMPOENDERECO, 
 wxID_FRAMEADDPROFESSORCAMPOFIXO, wxID_FRAMEADDPROFESSORCAMPONOME, 
 wxID_FRAMEADDPROFESSORCAMPONOMEP, wxID_FRAMEADDPROFESSORCAMPONUMERO, 
 wxID_FRAMEADDPROFESSORCAMPOUF, wxID_FRAMEADDPROFESSORNOMEBAIRRO, 
 ...
 wxID_FRAMEADDPROFESSORNOMECPF, wxID_FRAMEADDPROFESSORNOMEDATANASC, 
 wxID_FRAMEADDPROFESSORNOMENOME, wxID_FRAMEADDPROFESSORNOMENUMERO, 
 wxID_FRAMEADDPROFESSORNOMERUA, wxID_FRAMEADDPROFESSORNOMESEXO, 
 wxID_FRAMEADDPROFESSORNOMETELEFONE, wxID_FRAMEADDPROFESSORNOMEUF, 
 wxID_FRAMEADDPROFESSORPANEL1, wxID_FRAMEADDPROFESSORSTATICBITMAP1, 
 wxID_FRAMEADDPROFESSORSTATICLINE1, 
...
class FrameAddProfessor(wx.Frame):
    def _init_ctrls(self, prnt):
        ...
        self.botaoMasc = wx.RadioButton(id=wxID_FRAMEADDPROFESSORBOTAOMASC,
              ...
              pos=wx.Point(733, 266), size=wx.Size(81, 13), style=0)
        ...
        self.botaoFeminino = wx.RadioButton(id=wxID_FRAMEADDPROFESSORBOTAOFEMININO,
              ...
              pos=wx.Point(828, 267), size=wx.Size(81, 13), style=0)
        self.botaoFeminino.SetValue(True)

        self.campoCep = wx.TextCtrl(id=wxID_FRAMEADDPROFESSORCAMPOCEP,
              name=u'campoCep', parent=self.panel1, pos=wx.Point(407, 323),
        ...
        self.campoUF = wx.TextCtrl(id=wxID_FRAMEADDPROFESSORCAMPOUF,
              name=u'campoUF', parent=self.panel1, pos=wx.Point(653, 499),
        ...
        self.staticLine1 = wx.StaticLine(id=wxID_FRAMEADDPROFESSORSTATICLINE1,
              name='staticLine1', parent=self.panel1, pos=wx.Point(367, 168),
